...
-----------------------------------------------
Kaynak: https://obilet.com/tr/otobus-bileti/{origin}-to-{dest}
...
class ObiletScraper:
    """Obilet.com şehirlerarası otobüs fiyat scraper'ı."""
    ...
    async def scrape(
        ...
        raise NotImplementedError(
            f"ObiletScraper.scrape() henüz implemente edilmedi "
